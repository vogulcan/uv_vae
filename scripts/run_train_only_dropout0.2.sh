#!/bin/bash
#SBATCH --job-name=vae-train-dropout0.2
...
#SBATCH --output=/cta/users/patrickgao765/uv_vae/train_dropout0.2_%j.log
#SBATCH --error=/cta/users/patrickgao765/uv_vae/train_dropout0.2_%j.err
#
